      ...
      <Tooltip.Root>
        <Tooltip.Trigger asChild>
          <a
            ...
            className="hover:bg-bolt-elements-item-backgroundActive text-bolt-elements-text-secondary z-50 inline-flex h-8 w-8 items-center justify-center rounded-sm hover:text-[#000000]"
            onClick={(e) => {
              e.stopPropagation();
            }}
          >
            <div className={`i-ph:link h-4 w-4 hover:text-blue-400 ${isLoading ? 'animate-pulse' : ''}`} />
          </a>
        </Tooltip.Trigger>
        <Tooltip.Portal>
