...
export default function NetlifyConnection() {
          ...
          <CollapsibleTrigger asChild>
            <div className="bg-bolt-elements-background dark:bg-bolt-elements-background-depth-2 border-bolt-elements-border-color dark:border-bolt-elements-border-color hover:border-bolt-elements-border-color-active/70 dark:hover:border-bolt-elements-border-color-active/70 flex items-center justify-between rounded-lg border p-4 transition-all duration-200">
              <div className="flex items-center gap-2">
                <div className="i-ph:chart-bar text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                <span className="text-sm font-medium text-black dark:text-black">Netlify Stats</span>
              </div>
              <div
                className={cn(
          ...
          <CollapsibleContent className="overflow-hidden">
            <div className="mt-4 space-y-4">
              <div className="flex flex-wrap items-center gap-4">
                <Badge variant="outline" className="flex items-center gap-1 text-black dark:text-black">
                  <BuildingLibraryIcon className="text-bolt-elements-item-contentAccent h-4 w-4" />
                  <span>{connection.stats.totalSites} Sites</span>
                </Badge>
                <Badge variant="outline" className="flex items-center gap-1 text-black dark:text-black">
                  <RocketLaunchIcon className="text-bolt-elements-item-contentAccent h-4 w-4" />
                  <span>{deploymentCount} Deployments</span>
                </Badge>
                {lastUpdated && (
                  <Badge variant="outline" className="flex items-center gap-1 text-black dark:text-black">
                    <ClockIcon className="text-bolt-elements-item-contentAccent h-4 w-4" />
              ...
              {sites.length > 0 && (
                <div className="mt-4 space-y-4">
                  <div className="bg-bolt-elements-background dark:bg-bolt-elements-background-depth-1 border-bolt-elements-border-color dark:border-bolt-elements-border-color rounded-lg border p-4">
                    <div className="mb-4 flex items-center justify-between">
                      <h4 className="flex items-center gap-2 text-sm font-medium text-black dark:text-black">
                        <BuildingLibraryIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                        Your Sites
                      </h4>
                      <Button
                        variant="outline"
                        ...
                        className="hover:bg-bolt-elements-item-backgroundActive/10 flex items-center gap-2 text-black dark:text-black"
                      >
                        <ArrowPathIcon
                          className={cn(
                            'text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4',
                    ...
                    <div className="space-y-3">
                      {sites.map((site, index) => (
                        <div
                          key={site.id}
                          className={cn(
                            'bg-bolt-elements-background dark:bg-bolt-elements-background-depth-1 rounded-lg border p-4 transition-all',
                            activeSiteIndex === index
                              ? 'border-bolt-elements-item-contentAccent bg-bolt-elements-item-backgroundActive/10'
                              : 'border-bolt-elements-border-color hover:border-bolt-elements-border-color-active/70',
                          )}
                          onClick={() => {
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-2">
                              <CloudIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-5 w-5" />
                              <span className="font-medium text-black dark:text-black">{site.name}</span>
                            </div>
                            <div className="flex items-center gap-2">
                              <Badge
                          ...
                          <div className="mt-3 flex items-center gap-2">
                            <a
                              ...
                              className="text-bolt-elements-link-text hover:text-bolt-elements-link-textHover dark:hover:text-bolt-elements-link-textHover flex items-center gap-1 text-sm transition-colors dark:text-white"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <CloudIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-3 w-3" />
                          ...
                          {activeSiteIndex === index && (
                            <>
                              <div className="border-bolt-elements-border-color mt-4 border-t pt-3">
                                <div className="flex items-center gap-2">
                                  {siteActions.map((action) => (
                                    <Button
                                      ...
                                      className="flex items-center gap-1 text-black dark:text-black"
                                    >
                                      <action.icon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                                      {action.name}
                                    </Button>
                                  ))}
                                </div>
                              ...
                              {site.published_deploy && (
                                <div className="mt-3 text-sm">
                                  <div className="flex items-center gap-1">
                                    <ClockIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                                    <span className="text-bolt-elements-text-secondary dark:text-bolt-elements-text-secondary">
                                      Published {formatDistanceToNow(new Date(site.published_deploy.published_at))} ago
                                    </span>
                                  </div>
                                  {site.published_deploy.branch && (
                                    <div className="mt-1 flex items-center gap-1">
                                      <CodeBracketIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                                      <span className="text-bolt-elements-text-secondary dark:text-bolt-elements-text-secondary">
                    ...
                    <div className="bg-bolt-elements-background dark:bg-bolt-elements-background-depth-1 border-bolt-elements-border-color dark:border-bolt-elements-border-color rounded-lg border p-4">
                      ...
                      <div className="space-y-2">
                        {deploys.map((deploy) => (
                          <div
                            key={deploy.id}
                            className="bg-bolt-elements-background dark:bg-bolt-elements-background-depth-1 border-bolt-elements-border-color dark:border-bolt-elements-border-color rounded-lg border p-3"
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                                ...
                                >
                                  ...
                                  <span className="text-black dark:text-black">{deploy.state}</span>
                                </Badge>
                              </div>
                              <span className="text-bolt-elements-text-secondary dark:text-bolt-elements-text-secondary text-xs">
                                {formatDistanceToNow(new Date(deploy.created_at))} ago
                              </span>
                            </div>
                            {deploy.branch && (
                              <div className="text-bolt-elements-text-secondary dark:text-bolt-elements-text-secondary mt-2 flex items-center gap-1 text-xs">
                                <CodeBracketIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-3 w-3" />
                                <span className="text-bolt-elements-text-secondary dark:text-bolt-elements-text-secondary">
                            ...
                            {deploy.deploy_url && (
                              <div className="mt-2 text-xs">
                                <a
                                  ...
                                  target="_blank"
                                  rel="noopener noreferrer"
                                  className="text-bolt-elements-link-text hover:text-bolt-elements-link-textHover dark:hover:text-bolt-elements-link-textHover flex items-center gap-1 transition-colors dark:text-white"
                                  onClick={(e) => e.stopPropagation()}
                                >
                                  <CloudIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-3 w-3" />
                            ...
                            <div className="mt-2 flex items-center gap-2">
                              ...
                              {deploy.state === 'ready' ? (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-black dark:text-black"
                                >
                                  <LockClosedIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                                  Lock
                                </Button>
                              ) : (
                                <Button
                                  ...
                                  className="flex items-center gap-1 text-black dark:text-black"
                                >
                                  <LockOpenIcon className="text-bolt-elements-item-contentAccent dark:text-bolt-elements-item-contentAccent h-4 w-4" />
                                  Unlock
                                </Button>
                              )}
                            </div>
                          ...
                          >
                            <div className="flex items-center justify-between">
                              <div className="flex items-center gap-2">
                                <Badge
                                  variant={
                                    build.done && !build.error ? 'primary' : build.error ? 'destructive' : 'outline'
                                  }
                                  className="flex items-center gap-1"
                                >
                            ...
                            {build.error && (
                              <div className="text-bolt-elements-textDestructive dark:text-bolt-elements-textDestructive mt-2 flex items-center gap-1 text-xs">
                                <XCircleIcon className="text-bolt-elements-textDestructive dark:text-bolt-elements-textDestructive h-3 w-3" />
                                Error: {build.error}
                              </div>
                            )}
                          </div>
  ...
  return (
    <div className="bg-bolt-elements-background dark:bg-bolt-elements-background border-bolt-elements-border-color dark:border-bolt-elements-border-color space-y-6 rounded-lg border">
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-medium text-black">Netlify Connection</h2>
          </div>
        </div>
